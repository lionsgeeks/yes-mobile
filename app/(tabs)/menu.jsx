...
export default function MenuScreen() {
    const { isSignedIn, setIsSignedIn, user, token } = useAuthContext();
            ...
            <View className="flex-row flex-wrap">
                {
                    gridTabs.map((tab, index) => (
                        <TouchableOpacity
                            ...
                            key={index}
                            className="w-[45%] h-[19%] items-center justify-center px-3 py-1 rounded-xl
                    ...
                    isSignedIn ?
                        <>
                            ...
                            >
                                ...
                                <Text className="text-red-500 text-lg font-semibold">Delete Account</Text>
                            </TouchableOpacity>
                            <SignOutButton />
                        </>
                        :
